...
(() => {
          ...
          if (t.value) {
            if ("arbitrary" === t.value.kind) {
              ...
              switch (
                ...
                default:
                  return (
                    (r = Fe(r, t.modifier, e)), null === r ? void 0 : [x("background-color", r)]
                  );
              }
            }
            {
            ...
            if (t.value) {
              if ("arbitrary" === t.value.kind) {
                ...
                switch (t.value.dataType ?? ie(r, ["color", "number", "length", "percentage"])) {
                  ...
                  default:
                    return (
                      (r = Fe(t.value.value, t.modifier, e)), null === r ? void 0 : [x("stroke", r)]
                    );
                }
              }
              {
            ...
            t.functional("outline", (t) => {
              ...
              if ("arbitrary" === t.value.kind) {
                ...
                switch (t.value.dataType ?? ie(r, ["color", "length", "number", "percentage"])) {
                  ...
                  default:
                    return (
                      (r = Fe(r, t.modifier, e)), null === r ? void 0 : [x("outline-color", r)]
                    );
                }
              }
              {
  ...
  function Yt(e, { config: t, base: r, path: n, reference: o }) {
    ...
    for (let t of i)
      e.plugins.push(t),
        t.config && Yt(e, { path: n, base: r, config: t.config, reference: !!t.reference });
    let a = t.content ?? [],
  ...
  async function er({ designSystem: e, base: t, ast: r, loadModule: n, sources: o }) {
    ...
    return (
      (i |= tr({ designSystem: e, base: t, ast: r, sources: o, configs: c, pluginDetails: u })), i
    );
  }
